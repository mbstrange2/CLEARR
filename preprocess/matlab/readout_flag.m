...
outputPath = '/sim/dantemur/readout/data/2015-11-09-3/flag/data000';
...
while nSamplesToCopy > 0
    ...
    parfor i=1:nSamples
        [newData(i,:)] = ramp_adc_flag_mex(rawData(i,:),offsetPerChannel...
            ,posLin,Beff,FSeff);
    end
...
nch = 412;
%t = 550:1:700;
plot(t,rawData(t,nch),t,newData(t,nch));
